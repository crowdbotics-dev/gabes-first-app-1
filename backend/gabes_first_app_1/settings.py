"""
Django settings for gabes_first_app_1 project.
...
ROOT_URLCONF = 'gabes_first_app_1.urls'
...
WSGI_APPLICATION = 'gabes_first_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gabes_first_app_1 API",
    "DESCRIPTION": "API documentation for gabes_first_app_1 App",
    "VERSION": "v1",
}
